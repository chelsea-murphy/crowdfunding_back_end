...
The JSON object contains a string, integer and boolean, such as: `{"title": "Matila Wormwood's 8th Birthday" "goal": 100, "is_open": true,}` and Auth token required (run the POST User token with username, email and password to source the User token)
![POST method - New fundraiser](<POST method - New fundraiser.png>)
![Auth Token](<Screenshot 2025-12-13 at 11.39.57 am.png>)![API Token Auth](<Screenshot 2025-12-13 at 11.42.33 am.png>)